                ...
                <div className="px-4 py-2">
                    ...
                    <div className="flex gap-2 justify-center pb-2">
                        {relatedItems.map((item) => (
                            <Link
                                key={item.href}
                                to={item.href}
                                className="flex-1 max-w-[140px] flex flex-col items-center gap-1 bg-surface border border-border rounded-lg px-2.5 py-2 active:bg-brand active:text-white transition-all overflow-hidden"
                            >
                    ...
                    <div className="flex gap-2 justify-center pt-1 border-t border-border mt-1">
                        ...
                        <a
                            ...
                            className="flex-1 max-w-[140px] flex items-center justify-center gap-2 bg-[#25D366] text-white border border-[#25D366] rounded-lg px-3 py-2 active:opacity-80 transition-all font-semibold"
                        >
