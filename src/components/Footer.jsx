...
function WhatsAppButton() {
    ...
    return (
        <a
            ...
            className="bg-[#25D366] text-white p-4 rounded-md shadow-lg hover:-translate-y-1 hover:shadow-xl transition-all flex items-center justify-center focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-[#25D366] focus-visible:ring-offset-4"
...
function ScrollToTopButton() {
    ...
    return (
        <button
            ...
            className={`bg-white text-brand p-4 rounded-md shadow-lg hover:-translate-y-1 hover:shadow-xl transition-all flex items-center justify-center focus:outline-none focus-visible:ring-2 focus-visible:ring-brand focus-visible:ring-offset-2 focus-visible:ring-offset-white ${
...
function ContactButton() {
    return (
        <a
            href="/contact"
            className="bg-brand text-white p-4 rounded-md shadow-lg hover:-translate-y-1 hover:shadow-xl transition-all flex items-center justify-center focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-brand"
